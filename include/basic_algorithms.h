...
/// @return 
inline float getForgettingFactor(int forget_count, float stability_factor=2.f){
...
static float gaussian_randoms[GAUSSIAN_RANDOM_NUM]; ///< Store Gaussian randoms with center 0 and predefined stddev
static float standard_gaussian_pdf[GAUSSIAN_PDF_NUM]; ///< Store Standard Gaussian PDF. Range[-10, 10]; 10 sigma
...
public:
    ...
    /// @brief Initialize the Gaussian Random Calculator
    /// @param stddev: The preset stddev of the Gaussian randoms
    void initialize(double stddev = 1.0)
    {
