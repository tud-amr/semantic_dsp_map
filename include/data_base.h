...
struct LabeledPoint
{
    ...
    ///< Position of the free space point. Global coordinate system.
    Eigen::Vector3f free_position; //CHG
...
/// Define the dataset type that can be used
enum Dataset_Type
{
    VIRTUAL_KITTI2
}Dataset_Type;
...
const int c_movable_object_label_id_start = 13;
