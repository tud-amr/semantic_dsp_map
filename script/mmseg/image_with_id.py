...
"""autogenerated by genpy from mask_kpts_msgs/ImageWithID.msg. Do not edit."""
import codecs
import sys
...
class ImageWithID(genpy.Message):
  _md5sum = "cf6190bf75d17edec911ea396abe8873"
  _type = "mask_kpts_msgs/ImageWithID"
...
"""
  __slots__ = ['id','image']
  _slot_types = ['uint32','sensor_msgs/Image']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ImageWithID, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_4I().pack(_x.id, _x.image.header.seq, _x.image.header.stamp.secs, _x.image.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.id, _x.image.header.seq, _x.image.header.stamp.secs, _x.image.header.stamp.nsecs,) = _get_struct_4I().unpack(str[start:end])
      start = end
      end += 4
